...
class Ui_MainWindow(object):
    ...
    def insert_teacher_sql(self):
        insert_teacher_sql = "insert into teacher (t_id, t_name, t_sex, t_age, t_did, t_tel) values ("
        ...
        if age_text != "":
            try:
                ...
                QtWidgets.QMessageBox(QtWidgets.QMessageBox.NoIcon, 'Warning',
                                      'Error age! Please input an INT number!').exec()
        insert_value = "'" + tid_text + "', '" + tname_text + "', '" + tsex_text + "', '" + str(
            tage_text) + "', '" + tdid_text + "', '" + ttel_text + "'"
        insert_value.replace("''", "null")
